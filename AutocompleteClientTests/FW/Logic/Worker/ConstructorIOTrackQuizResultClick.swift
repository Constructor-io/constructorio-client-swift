...
class ConstructorIOTrackQuizResultClick: XCTestCase {
    ...
    func testTrackQuizResultClick() {
        ...
        stub(regex("https://ac.cnstrc.com/v2/behavioral_action/quiz_result_click?_dt=\(kRegexTimestamp)&c=\(kRegexVersion)&i=\(kRegexClientID)&key=\(kRegexAutocompleteKey)&s=\(kRegexSession)&section=Products"), builder.create())
    ...
    func testTrackQuizResultClick_WithSection() {
        ...
        stub(regex("https://ac.cnstrc.com/v2/behavioral_action/quiz_result_click?_dt=\(kRegexTimestamp)&c=\(kRegexVersion)&i=\(kRegexClientID)&key=\(kRegexAutocompleteKey)&s=\(kRegexSession)&section=\(self.sectionName)"), builder.create())
    ...
    func testTrackQuizResultClick_WithSectionFromConfig() {
        ...
        stub(regex("https://ac.cnstrc.com/v2/behavioral_action/quiz_result_click?_dt=\(kRegexTimestamp)&c=\(kRegexVersion)&i=\(kRegexClientID)&key=\(kRegexAutocompleteKey)&s=\(kRegexSession)&section=testSection123"), builder.create())
    ...
    func testTrackQuizResultClick_With400() {
        ...
        stub(regex("https://ac.cnstrc.com/v2/behavioral_action/quiz_result_click?_dt=\(kRegexTimestamp)&c=\(kRegexVersion)&i=\(kRegexClientID)&key=\(kRegexAutocompleteKey)&s=\(kRegexSession)&section=Products"), http(400))
    ...
    func testTrackQuizResultClick_With500() {
        ...
        stub(regex("https://ac.cnstrc.com/v2/behavioral_action/quiz_result_click?_dt=\(kRegexTimestamp)&c=\(kRegexVersion)&i=\(kRegexClientID)&key=\(kRegexAutocompleteKey)&s=\(kRegexSession)&section=Products"), http(500))
        self.constructor.trackQuizResultClick(quizID: self.quizID, quizVersionID: self.quizVersionID, quizSessionID: self.quizSessionID, customerID: self.customerID, completionHandler: { response in
            if let cioError = response.error as? CIOError {
    ...
    func testTrackQuizResultClick_WithNoConnectivity() {
        ...
        stub(regex("https://ac.cnstrc.com/v2/behavioral_action/quiz_result_click?_dt=\(kRegexTimestamp)&c=\(kRegexVersion)&i=\(kRegexClientID)&key=\(kRegexAutocompleteKey)&s=\(kRegexSession)&section=Products"), noConnectivity())
        self.constructor.trackQuizResultClick(quizID: self.quizID, quizVersionID: self.quizVersionID, quizSessionID: self.quizSessionID, customerID: self.customerID, completionHandler: { response in
            if let cioError = response.error as? CIOError {
