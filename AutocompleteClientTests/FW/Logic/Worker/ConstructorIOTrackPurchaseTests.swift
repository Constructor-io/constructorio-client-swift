...
class ConstructorIOTrackPurchaseTests: XCTestCase {
    ...
    func testTrackPurchase() {
        ...
        stub(regex("https://ac.cnstrc.com/v2/behavioral_action/purchase?_dt=\(kRegexTimestamp)&autocomplete_section=Products&c=\(kRegexVersion)&i=\(kRegexClientID)&key=\(kRegexAutocompleteKey)&s=\(kRegexSession)"), builder.create())
    ...
    func testTrackPurchase_WithSection() {
        ...
        stub(regex("https://ac.cnstrc.com/v2/behavioral_action/purchase?_dt=\(kRegexTimestamp)&autocomplete_section=Search%20Suggestions&c=\(kRegexVersion)&i=\(kRegexClientID)&key=\(kRegexAutocompleteKey)&s=\(kRegexSession)"), builder.create())
    ...
    func testTrackPurchase_With400() {
        ...
        let customerIDs = ["customer_id_q2ew"]
        stub(regex("https://ac.cnstrc.com/v2/behavioral_action/purchase?_dt=\(kRegexTimestamp)&autocomplete_section=Products&c=\(kRegexVersion)&i=\(kRegexClientID)&key=\(kRegexAutocompleteKey)&s=\(kRegexSession)"), http(400))
    ...
    func testTrackPurchase_With500() {
        ...
        let customerIDs = ["customer_id_q2ew"]
        stub(regex("https://ac.cnstrc.com/v2/behavioral_action/purchase?_dt=\(kRegexTimestamp)&autocomplete_section=Products&c=\(kRegexVersion)&i=\(kRegexClientID)&key=\(kRegexAutocompleteKey)&s=\(kRegexSession)"), http(500))
        self.constructor.trackPurchase(customerIDs: customerIDs, sectionName: nil, completionHandler: { error in
            if let cioError = error as? CIOError {
    ...
    func testTrackPurchase_WithNoConnectivity() {
        ...
        let customerIDs = ["customer_id_q2ew"]
        stub(regex("https://ac.cnstrc.com/v2/behavioral_action/purchase?_dt=\(kRegexTimestamp)&autocomplete_section=Products&c=\(kRegexVersion)&i=\(kRegexClientID)&key=\(kRegexAutocompleteKey)&s=\(kRegexSession)"), noConnectivity())
        self.constructor.trackPurchase(customerIDs: customerIDs, sectionName: nil, completionHandler: { error in
            if let cioError = error as? CIOError {
