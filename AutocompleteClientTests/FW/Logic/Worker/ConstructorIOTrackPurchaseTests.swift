...
class ConstructorIOTrackPurchaseTests: XCTestCase {
    ...
    func testTrackPurchase() {
        ...
        stub(regex("https://ac.cnstrc.com/v2/behavioral_action/purchase?_dt=\(kRegexTimestamp)&c=\(kRegexVersion)&i=\(kRegexClientID)&key=\(kRegexAutocompleteKey)&s=\(kRegexSession)&section=Products&\(TestConstants.defaultSegments)"), builder.create())
    ...
    func testTrackPurchase_WithSection() {
        ...
        stub(regex("https://ac.cnstrc.com/v2/behavioral_action/purchase?_dt=\(kRegexTimestamp)&c=\(kRegexVersion)&i=\(kRegexClientID)&key=\(kRegexAutocompleteKey)&s=\(kRegexSession)&section=Search%20Suggestions&\(TestConstants.defaultSegments)"), builder.create())
    ...
    func testTrackPurchase_With400() {
        ...
        let customerIDs = ["customer_id_q2ew"]
        stub(regex("https://ac.cnstrc.com/v2/behavioral_action/purchase?_dt=\(kRegexTimestamp)&c=\(kRegexVersion)&i=\(kRegexClientID)&key=\(kRegexAutocompleteKey)&s=\(kRegexSession)&section=Products&\(TestConstants.defaultSegments)"), http(400))
    ...
    func testTrackPurchase_With500() {
        ...
        let customerIDs = ["customer_id_q2ew"]
        stub(regex("https://ac.cnstrc.com/v2/behavioral_action/purchase?_dt=\(kRegexTimestamp)&c=\(kRegexVersion)&i=\(kRegexClientID)&key=\(kRegexAutocompleteKey)&s=\(kRegexSession)&section=Products&\(TestConstants.defaultSegments)"), http(500))
        self.constructor.trackPurchase(customerIDs: customerIDs, sectionName: nil, completionHandler: { response in
            if let cioError = response.error as? CIOError {
    ...
    func testTrackPurchase_WithNoConnectivity() {
        ...
        let customerIDs = ["customer_id_q2ew"]
        stub(regex("https://ac.cnstrc.com/v2/behavioral_action/purchase?_dt=\(kRegexTimestamp)&c=\(kRegexVersion)&i=\(kRegexClientID)&key=\(kRegexAutocompleteKey)&s=\(kRegexSession)&section=Products&\(TestConstants.defaultSegments)"), noConnectivity())
        self.constructor.trackPurchase(customerIDs: customerIDs, sectionName: nil, completionHandler: { response in
            if let cioError = response.error as? CIOError {
