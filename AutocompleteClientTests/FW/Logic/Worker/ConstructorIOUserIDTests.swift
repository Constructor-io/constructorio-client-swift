...
class ConstructorIOUserIDTests: XCTestCase {
    ...
    func testAutocomplete() {
        ...
        stub(regex("https://ac.cnstrc.com/autocomplete/a%20term?_dt=\(kRegexTimestamp)&c=\(kRegexVersion)&i=\(kRegexClientID)&key=\(kRegexAutocompleteKey)&s=\(kRegexSession)&ui=abcdefg&\(TestConstants.defaultSegments)"), builder.create())
    ...
    func testTrackInputFocus() {
        ...
        stub(regex("https://ac.cnstrc.com/behavior?_dt=\(kRegexTimestamp)&action=focus&c=\(kRegexVersion)&i=\(kRegexClientID)&key=\(kRegexAutocompleteKey)&s=\(kRegexSession)&term=corn&ui=abcdefg&\(TestConstants.defaultSegments)"), builder.create())
