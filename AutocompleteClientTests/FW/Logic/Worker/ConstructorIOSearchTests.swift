...
class ConstructorIOSearchTests: XCTestCase {
    ...
    func testSearch_AttachesNumResultsParameter(){
    ...
    func testSearch_AttachesGroupFilter(){
        let query = CIOSearchQuery(query: "potato", filters: CIOSearchQueryFilters(groupFilter: "151", facetFilters: nil))
    ...
    func testSearch_AttachesFacetFilter(){
        ...
        let query = CIOSearchQuery(query: "potato", filters: CIOSearchQueryFilters(groupFilter: nil, facetFilters: facetFilters))
