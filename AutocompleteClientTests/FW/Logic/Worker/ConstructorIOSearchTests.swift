...
class ConstructorIOSearchTests: XCTestCase {
    ...
    func testSearch_CreatesValidRequest() {
        ...
        stub(regex("https://ac.cnstrc.com/search/potato?_dt=\(kRegexTimestamp)&c=\(kRegexVersion)&i=\(kRegexClientID)&key=key_OucJxxrfiTVUQx0C&num_results_per_page=30&page=1&s=\(kRegexSession)&section=Products&\(TestConstants.defaultSegments)"), builder.create())
    ...
    func testSearch_WithValidRequest_ReturnsNonNilResponse() {
        ...
        stub(regex("https://ac.cnstrc.com/search/potato?_dt=\(kRegexTimestamp)&c=\(kRegexVersion)&i=\(kRegexClientID)&key=\(kRegexAutocompleteKey)&num_results_per_page=30&page=1&s=\(kRegexSession)&section=Products&\(TestConstants.defaultSegments)"), http(200, data: dataToReturn))
    ...
    func testSearch_ReturnsErrorObject_IfAPIReturnsInvalidResponse() {
        ...
        stub(regex("https://ac.cnstrc.com/search/potato?_dt=\(kRegexTimestamp)&c=\(kRegexVersion)&i=\(kRegexClientID)&key=\(kRegexAutocompleteKey)&num_results_per_page=30&page=1&s=\(kRegexSession)&section=Products&\(TestConstants.defaultSegments)"), http(404))
    ...
    func testSearch_AttachesPageParameter() {
        ...
        let builder = CIOBuilder(expectation: "Calling Search should send a valid request.", builder: http(200))
        stub(regex("https://ac.cnstrc.com/search/potato?_dt=\(kRegexTimestamp)&c=\(kRegexVersion)&i=\(kRegexClientID)&key=\(kRegexAutocompleteKey)&num_results_per_page=30&page=5&s=\(kRegexSession)&section=Products&\(TestConstants.defaultSegments)"), builder.create())
        self.constructor.search(forQuery: query, completionHandler: { response in })
        self.wait(for: builder.expectation)
    }
    ...
    func testSearch_AttachesCustomSectionParameter() {
        ...
        let builder = CIOBuilder(expectation: "Calling Search should send a valid request.", builder: http(200))
        stub(regex("https://ac.cnstrc.com/search/potato?_dt=\(kRegexTimestamp)&c=\(kRegexVersion)&i=\(kRegexClientID)&key=\(kRegexAutocompleteKey)&num_results_per_page=30&page=1&s=\(kRegexSession)&section=\(customSection)&\(TestConstants.defaultSegments)"), builder.create())
    ...
    func testRedirect_hasCorrectURL() {
        ...
        stub(regex("https://ac.cnstrc.com/search/dior?_dt=\(kRegexTimestamp)&c=\(kRegexVersion)&i=\(kRegexClientID)&key=\(kRegexAutocompleteKey)&num_results_per_page=30&page=1&s=\(kRegexSession)&section=Products&\(TestConstants.defaultSegments)"), http(200, data: TestResource.load(name: TestResource.Response.searchJSONRedirectFile)))
    ...
    func testSearch_AttachesGroupFilter() {
        ...
        stub(regex("https://ac.cnstrc.com/search/potato?_dt=\(kRegexTimestamp)&c=\(kRegexVersion)&filters%5Bgroup_id%5D=151&i=\(kRegexClientID)&key=\(kRegexAutocompleteKey)&num_results_per_page=30&page=1&s=\(kRegexSession)&section=Products&\(TestConstants.defaultSegments)"), builder.create())
    ...
    func testSearch_AttachesFacetFilter() {
        ...
        stub(regex("https://ac.cnstrc.com/search/potato?_dt=\(kRegexTimestamp)&c=\(kRegexVersion)&filters%5Bfacet1%5D=Organic&i=\(kRegexClientID)&key=\(kRegexAutocompleteKey)&num_results_per_page=30&page=1&s=\(kRegexSession)&section=Products&\(TestConstants.defaultSegments)"), builder.create())
    ...
    func testSearch_WithPlusSignInQueryParams_ShouldBeEncoded() {
        ...
        stub(regex("https://ac.cnstrc.com/search/potato?_dt=\(kRegexTimestamp)&c=\(kRegexVersion)&filters%5Bage%5D=10%2B&filters%5Bsize%5D=6%2B&i=\(kRegexClientID)&key=\(kRegexAutocompleteKey)&num_results_per_page=30&page=1&s=\(kRegexSession)&section=Products&\(TestConstants.defaultSegments)"), builder.create())
    ...
    func testSearch_AttachesGroupsSortOption() {
        ...
        let builder = CIOBuilder(expectation: "Calling Search with 200 should return a response", builder: http(200))
        stub(regex("https://ac.cnstrc.com/search/potato?_dt=\(kRegexTimestamp)&c=\(kRegexVersion)&fmt_options%5Bgroups_sort_by%5D=value&fmt_options%5Bgroups_sort_order%5D=ascending&i=\(kRegexClientID)&key=\(kRegexAutocompleteKey)&num_results_per_page=30&page=1&s=\(kRegexSession)&section=Products&\(TestConstants.defaultSegments)"), builder.create())
    ...
    func testSearch_UsingSearchQueryBuilder_WithValidRequest_ReturnsNonNilResponse() {
        ...
        stub(regex("https://ac.cnstrc.com/search/potato?_dt=\(kRegexTimestamp)&c=\(kRegexVersion)&i=\(kRegexClientID)&key=\(kRegexAutocompleteKey)&num_results_per_page=30&page=1&s=\(kRegexSession)&section=Products&\(TestConstants.defaultSegments)"), builder.create())
    ...
    func testSearch_UsingSearchQueryBuilder_AttachesPageParams() {
        ...
        let builder = CIOBuilder(expectation: "Calling Search with valid parameters should return a non-nil response.", builder: http(200))
        stub(regex("https://ac.cnstrc.com/search/potato?_dt=\(kRegexTimestamp)&c=\(kRegexVersion)&i=\(kRegexClientID)&key=\(kRegexAutocompleteKey)&num_results_per_page=50&page=5&s=\(kRegexSession)&section=Products&\(TestConstants.defaultSegments)"), builder.create())
    ...
    func testSearch_UsingSearchQueryBuilder_AttachesSortOption() {
        ...
        let builder = CIOBuilder(expectation: "Calling Search with valid parameters should return a non-nil response.", builder: http(200))
        stub(regex("https://ac.cnstrc.com/search/potato?_dt=\(kRegexTimestamp)&c=\(kRegexVersion)&i=\(kRegexClientID)&key=\(kRegexAutocompleteKey)&num_results_per_page=30&page=1&s=\(kRegexSession)&section=Products&sort_by=relevance&sort_order=descending&\(TestConstants.defaultSegments)"), builder.create())
    ...
    func testSearch_UsingSearchQueryBuilder_AttachesFacetFilters() {
        ...
        let builder = CIOBuilder(expectation: "Calling Search with multiple facet filters with the same name should have a multiple facet URL query items", builder: http(200))
        stub(regex("https://ac.cnstrc.com/search/potato?_dt=\(kRegexTimestamp)&c=\(kRegexVersion)&filters%5BfacetOne%5D=Natural&filters%5BfacetOne%5D=Organic&filters%5BfacetOne%5D=Whole-grain&i=\(kRegexClientID)&key=\(kRegexAutocompleteKey)&num_results_per_page=50&page=5&s=\(kRegexSession)&section=Products&\(TestConstants.defaultSegments)"), builder.create())
    ...
    func testSearch_UsingSearchQueryBuilder_AttachesHiddenFacets() {
        ...
        let builder = CIOBuilder(expectation: "Calling Search with multiple facet filters with the same name should have a multiple facet URL query items", builder: http(200))
        stub(regex("https://ac.cnstrc.com/search/potato?_dt=\(kRegexTimestamp)&c=\(kRegexVersion)&fmt_options%5Bhidden_facets%5D=hidden_facet_1&fmt_options%5Bhidden_facets%5D=hidden_facet_2&i=\(kRegexClientID)&key=\(kRegexAutocompleteKey)&num_results_per_page=30&page=1&s=\(kRegexSession)&section=Products&\(TestConstants.defaultSegments)"), builder.create())
