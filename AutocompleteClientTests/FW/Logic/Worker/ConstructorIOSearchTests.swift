...
class ConstructorIOSearchTests: XCTestCase {
    ...
    func testSearch_CreatesValidRequest() {
        ...
        stub(regex("https://ac.cnstrc.com/search/potato?_dt=\(kRegexTimestamp)&c=cioios-&i=\(kRegexClientID)&key=key_OucJxxrfiTVUQx0C&page=1&s=\(kRegexSession)&section=Products"), builder.create())
    ...
    func testSearch_WithValidRequest_ReturnsNonNilResponse() {
        ...
        stub(regex("https://ac.cnstrc.com/search/potato?_dt=\(kRegexTimestamp)&c=\(kRegexVersion)&i=\(kRegexClientID)&key=\(kRegexAutocompleteKey)&page=1&s=\(kRegexSession)&section=Products"), http(200, data: dataToReturn))
    ...
    func testSearch_ReturnsErrorObject_IfAPIReturnsInvalidResponse() {
        ...
        stub(regex("https://ac.cnstrc.com/search/potato?_dt=\(kRegexTimestamp)&c=\(kRegexVersion)&i=\(kRegexClientID)&key=\(kRegexAutocompleteKey)&page=1&s=\(kRegexSession)&section=Products"), http(404))
    ...
    func testSearch_AttachesPageParameter() {
        ...
        let builder = CIOBuilder(expectation: "Calling Search should send a valid request.", builder: http(200))
        stub(regex("https://ac.cnstrc.com/search/potato?_dt=\(kRegexTimestamp)&c=\(kRegexVersion)&i=\(kRegexClientID)&key=\(kRegexAutocompleteKey)&page=5&s=\(kRegexSession)&section=Products"), builder.create())
        self.constructor.search(forQuery: query, completionHandler: { response in })
        self.wait(for: builder.expectation)
    }
    ...
    func testRedirect_hasCorrectURL() {
        ...
        stub(regex("https://ac.cnstrc.com/search/dior?_dt=\(kRegexTimestamp)&c=\(kRegexVersion)&i=\(kRegexClientID)&key=\(kRegexAutocompleteKey)&page=1&s=\(kRegexSession)&section=Products"), http(200, data: TestResource.load(name: TestResource.Response.searchJSONRedirectFile)))
    ...
    func testSearch_AttachesGroupFilter() {
        ...
        stub(regex("https://ac.cnstrc.com/search/potato?_dt=\(kRegexTimestamp)&c=\(kRegexVersion)&filters%5Bgroup_id%5D=151&i=\(kRegexClientID)&key=\(kRegexAutocompleteKey)&page=1&s=\(kRegexSession)&section=Products"), builder.create())
    ...
    func testSearch_AttachesFacetFilter() {
        ...
        stub(regex("https://ac.cnstrc.com/search/potato?_dt=\(kRegexTimestamp)&c=\(kRegexVersion)&filters%5Bfacet1%5D=Organic&i=\(kRegexClientID)&key=\(kRegexAutocompleteKey)&page=1&s=\(kRegexSession)&section=Products"), builder.create())
    ...
    func testSearch_AttachesMultipleFacetFilters() {
        ...
        stub(regex("https://ac.cnstrc.com/search/potato?_dt=\(kRegexTimestamp)&c=\(kRegexVersion)&filters%5Bfacet10%5D=Whole-grain&filters%5Bfacet1%5D=Organic&filters%5Bfacet2%5D=Natural&i=\(kRegexClientID)&key=\(kRegexAutocompleteKey)&page=1&s=\(kRegexSession)&section=Products"), builder.create())
    ...
    func testSearch_AttachesMultipleFacetFiltersWithSameNameButDifferentValues() {
        ...
        stub(regex("https://ac.cnstrc.com/search/potato?_dt=\(kRegexTimestamp)&c=\(kRegexVersion)&filters%5BfacetOne%5D=Natural&filters%5BfacetOne%5D=Organic&filters%5BfacetOne%5D=Whole-grain&i=\(kRegexClientID)&key=\(kRegexAutocompleteKey)&page=1&s=\(kRegexSession)&section=Products"), builder.create())
