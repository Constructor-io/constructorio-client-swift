...
class ConstructorIOSearchTests: XCTestCase {
    ...
    func testSearch_CreatesValidRequest() {
        ...
        stub(regex("https://ac.cnstrc.com/search/potato?_dt=\(kRegexTimestamp)&c=cioios-&i=\(kRegexClientID)&key=key_OucJxxrfiTVUQx0C&num_results_per_page=30&page=1&s=\(kRegexSession)&section=Products"), builder.create())
