...
class ConstructorIOQuizTests: XCTestCase {
    ...
    func testQuizNextQuestion_CreatesValidRequest() {
        ...
        stub(regex("https://quizzes.cnstrc.com/v1/quizzes/test-quiz/next?_dt=\(kRegexTimestamp)&a=1&a=2&c=\(kRegexVersion)&i=\(kRegexClientID)&key=ZqXaOfXuBWD4s3XzCI1q&quiz_session_id=\(self.quizSessionID)&quiz_version_id=\(self.quizVersionID)&s=\(kRegexSession)&\(TestConstants.defaultSegments)"), builder.create())
    ...
    func testQuizResults_CreatesValidRequest() {
        ...
        stub(regex("https://quizzes.cnstrc.com/v1/quizzes/test-quiz/results?_dt=\(kRegexTimestamp)&a=1&a=2&c=\(kRegexVersion)&i=\(kRegexClientID)&key=ZqXaOfXuBWD4s3XzCI1q&quiz_session_id=\(self.quizSessionID)&quiz_version_id=\(self.quizVersionID)&s=\(kRegexSession)&\(TestConstants.defaultSegments)"), builder.create())
    ...
    func testQuizNextQuestion_WithValidRequest_ReturnsNonNilResponse() {
        ...
        stub(regex("https://quizzes.cnstrc.com/v1/quizzes/test-quiz/next?_dt=\(kRegexTimestamp)&a=1&c=\(kRegexVersion)&i=\(kRegexClientID)&key=ZqXaOfXuBWD4s3XzCI1q&s=\(kRegexSession)&\(TestConstants.defaultSegments)"), http(200, data: dataToReturn))
    ...
    func testQuizNextQuestion_ReturnsErrorObject_IfAPIReturnsInvalidResponse() {
        ...
        stub(regex("https://quizzes.cnstrc.com/v1/quizzes/test-quiz/next?_dt=\(kRegexTimestamp)&a=2&a=2&c=\(kRegexVersion)&i=\(kRegexClientID)&key=ZqXaOfXuBWD4s3XzCI1q&s=\(kRegexSession)&\(TestConstants.defaultSegments)"), http(404))
    ...
    func testQuizResults_ReturnsErrorObject_IfAPIReturnsInvalidResponse() {
        ...
        stub(regex("https://quizzes.cnstrc.com/v1/quizzes/test-quiz/results?_dt=\(kRegexTimestamp)&a=1&a=2&c=\(kRegexVersion)&i=\(kRegexClientID)&key=ZqXaOfXuBWD4s3XzCI1q&s=\(kRegexSession)&\(TestConstants.defaultSegments)"), http(404))
