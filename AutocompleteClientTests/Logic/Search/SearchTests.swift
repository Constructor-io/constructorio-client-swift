...
class SearchTests: XCTestCase {
    ...
    func testCallingSearch_CreatesValidRequest(){
        ...
        stub(regex("https://ac.cnstrc.com/search/potato?page=1&i=\(kRegexClientID)&c=cioios-&autocomplete_key=key_OucJxxrfiTVUQx0C&s=1&num_results_per_page=20&_dt=\(kRegexTimestamp)"), builder.create())
    ...
    func testCallingSearch_WithValidRequest_ReturnsNonNilResponse(){
        ...
        stub(regex("https://ac.cnstrc.com/search/potato?page=1&i=\(kRegexClientID)&c=cioios-&autocomplete_key=key_OucJxxrfiTVUQx0C&s=1&num_results_per_page=20&_dt=\(kRegexTimestamp)"), http(200, data: dataToReturn))
    ...
    func testCallingSearch_ReturnsErrorObject_IfAPIReturnsInvalidResponse(){
        ...
        stub(regex("https://ac.cnstrc.com/search/potato?page=1&i=\(kRegexClientID)&c=cioios-&autocomplete_key=key_OucJxxrfiTVUQx0C&s=1&num_results_per_page=20&_dt=\(kRegexTimestamp)"), http(404))
    ...
    func testCallingSearch_AttachesPageParameter(){
        ...
        let builder = CIOBuilder(expectation: "Calling Search should send a valid request.", builder: http(200))
        stub(regex("https://ac.cnstrc.com/search/potato?page=5&i=\(kRegexClientID)&c=cioios-&autocomplete_key=key_OucJxxrfiTVUQx0C&s=1&num_results_per_page=20&_dt=\(kRegexTimestamp)"), builder.create())
    ...
    func testCallingSearch_AttachesNumResultsParameter(){
        ...
        let builder = CIOBuilder(expectation: "Calling Search should send a valid request.", builder: http(200))
        stub(regex("https://ac.cnstrc.com/search/potato?page=1&i=\(kRegexClientID)&c=cioios-&autocomplete_key=key_OucJxxrfiTVUQx0C&s=1&num_results_per_page=11&_dt=\(kRegexTimestamp)"), builder.create())
    ...
    func testCallingSearch_AttachesGroupFilter(){
        ...
        stub(regex("https://ac.cnstrc.com/search/potato?page=1&i=\(kRegexClientID)&c=cioios-&autocomplete_key=key_OucJxxrfiTVUQx0C&s=1&filters%5Bgroup_id%5D=151&num_results_per_page=20&_dt=\(kRegexTimestamp)"), builder.create())
    ...
    func testCallingSearch_AttachesFacetFilter(){
        ...
        stub(regex("https://ac.cnstrc.com/search/potato?page=1&i=\(kRegexClientID)&c=cioios-&autocomplete_key=key_OucJxxrfiTVUQx0C&s=1&filters%5Bfacet1%5D=Organic&num_results_per_page=20&_dt=\(kRegexTimestamp)"), builder.create())
    ...
    func testCallingSearch_AttachesMultipleFacetFilters(){
        ...
        stub(regex("https://ac.cnstrc.com/search/potato?page=1&i=\(kRegexClientID)&filters%5Bfacet2%5D=Natural&c=cioios-&autocomplete_key=key_OucJxxrfiTVUQx0C&filters%5Bfacet10%5D=Whole-grain&s=1&filters%5Bfacet1%5D=Organic&num_results_per_page=20&_dt=\(kRegexTimestamp)"), builder.create())
    ...
    func testCallingSearch_AttachesMultipleFacetFiltersWithSameNameButDifferentValues(){
        ...
        stub(regex("https://ac.cnstrc.com/search/potato?page=1&i=\(kRegexClientID)&c=cioios-&autocomplete_key=key_OucJxxrfiTVUQx0C&s=1&filters%5BfacetOne%5D=Organic&filters%5BfacetOne%5D=Natural&filters%5BfacetOne%5D=Whole-grain&num_results_per_page=20&_dt=\(kRegexTimestamp)"), builder.create())
