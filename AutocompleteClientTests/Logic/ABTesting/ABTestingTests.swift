...
class ABTestingTests: XCTestCase {
    ...
    func testAutocompleteQueryContainsPassedCells() {
        ...
        stub(regex("https://ac.cnstrc.com/autocomplete/test?c=cioios-&autocomplete_key=key_OucJxxrfiTVUQx0C&s=1&ef-key1=value1&ef-key2=value2&ef-key3=value3&_dt=\(kRegexTimestamp)"), builder.create())
    ...
    func testTrackSearchRequestContainsPassedCells() {
        ...
        stub(regex("https://ac.cnstrc.com/autocomplete/item/search?item=item&original_query=term&autocomplete_key=key_OucJxxrfiTVUQx0C&c=cioios-&s=1&ef-key1=value1&ef-key2=value2&ef-key3=value3&_dt=\(kRegexTimestamp)"), builder.create())
        let constructor = ConstructorIO(config: config)
    ...
    func testTrackConversionRequestContainsPassedCells() {
        ...
        stub(regex("https://ac.cnstrc.com/autocomplete/term/conversion?item_id=itemID&revenue=10&c=cioios-&autocomplete_key=key_OucJxxrfiTVUQx0C&s=1&ef-key1=value1&ef-key2=value2&ef-key3=value3&autocomplete_section=section&_dt=\(kRegexTimestamp)"), builder.create())
        let constructor = ConstructorIO(config: config)
    ...
    func testTrackInputFocusRequestContainsPassedCells() {
        ...
        stub(regex("https://ac.cnstrc.com/behavior?action=focus&c=cioios-&autocomplete_key=key_OucJxxrfiTVUQx0C&s=1&ef-key1=value1&ef-key2=value2&ef-key3=value3&term=term&_dt=\(kRegexTimestamp)"), builder.create())
        let constructor = ConstructorIO(config: config)
    ...
    func testTrackAutocompleteClickDataRequestContainsPassedCells() {
        ...
        stub(regex("https://ac.cnstrc.com/autocomplete/itemName/search?tr=click&item=itemName&original_query=term&autocomplete_key=key_OucJxxrfiTVUQx0C&c=cioios-&s=1&ef-key1=value1&ef-key2=value2&ef-key3=value3&_dt=\(kRegexTimestamp)"), builder.create())
        let constructor = ConstructorIO(config: config)
    ...
    func testTrackSearchResultsLoadedRequestContainsPassedCells() {
        ...
        let builder = CIOBuilder(expectation: "Calling track autocomplete click should send a request containing all test cell values.", builder: http(200))
        stub(regex("https://ac.cnstrc.com/behavior?_dt=\(kRegexTimestamp)&action=search-results&c=cioios-&autocomplete_key=key_OucJxxrfiTVUQx0C&s=1&ef-key1=value1&ef-key2=value2&ef-key3=value3&term=term&num_results=1"), builder.create())
        let constructor = ConstructorIO(config: config)
