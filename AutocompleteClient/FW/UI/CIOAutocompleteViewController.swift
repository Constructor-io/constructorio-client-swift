...
extension CIOAutocompleteViewController: UITableViewDelegate, UITableViewDataSource {
    ...
    public func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        ...
        constructorIO.trackAutocompleteSelect(searchTerm: result.value, originalQuery: viewModel.searchTerm, sectionName: sectionName, group: result.group)

        // Track search
        constructorIO.trackSearchSubmit(searchTerm: result.value, originalQuery: viewModel.searchTerm, group: result.group)
