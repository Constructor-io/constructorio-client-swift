...
public struct CIOSearchQuery: CIORequestData {
    ...
    /**
     ...
     let searchQuery = CIOSearchQuery(query: "red", filters: CIOQueryFilters(groupFilter: nil, facetFilters: facetFilters), page: 1, perPage: 30, section: "Products", hiddenFields: ["hiddenField1", "hiddenField2"])
     ```
     */
